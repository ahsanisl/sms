...
import { useAdmissions, useCampuses } from "@/lib/store/hooks";
...
export default function LogInquiryPage() {
  ...
  const { addInquiry } = useAdmissions();
  ...
  const [campusId, setCampusId] = useState(scopedCampusId ?? activeCampuses[0]?.id ?? "");
  ...
  function handleSubmit(e: React.FormEvent) {
    ...
    addInquiry({ childName, gradeAppliedFor, campusId, parentName, parentPhone, parentEmail, source, notes: notes || undefined });
